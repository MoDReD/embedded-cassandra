...
public class CassandraExtension extends TestCassandra implements BeforeAllCallback, AfterAllCallback,
	 ...
	 * @param scripts CQL scripts to execute
	 */
	public CassandraExtension(@Nullable SessionFactory sessionFactory, CqlScript... scripts) {
	 ...
	 * @param scripts CQL scripts to execute
	 */
	public CassandraExtension(@Nullable CassandraFactory cassandraFactory, @Nullable SessionFactory sessionFactory,
			CqlScript... scripts) {
