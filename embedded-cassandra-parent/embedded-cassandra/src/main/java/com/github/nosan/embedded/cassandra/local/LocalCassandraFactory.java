...
public final class LocalCassandraFactory implements CassandraFactory {
	...
	private final List<WorkingDirectoryCustomizer> customizers = new ArrayList<>();
	...
	/**
	 * Initializes the value for the {@link LocalCassandraFactory#getLoggingFile() logging file} attribute.
	 *
	 ...
	 * @since 2.0.0
	 */
	public List<WorkingDirectoryCustomizer> getCustomizers() {
	...
	public LocalCassandra create() {
		...
		CassandraDatabase cassandraDatabase = new LocalCassandraDatabase(cassandraNode, workingDirectory,
				artifactDirectory, artifactFactory, isDeleteWorkingDirectory(), getMergedCustomizers());
	...
	private List<WorkingDirectoryCustomizer> getMergedCustomizers() {
